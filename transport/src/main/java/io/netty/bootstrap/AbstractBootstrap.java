...
public abstract class AbstractBootstrap<B extends AbstractBootstrap<B, C>, C extends Channel> implements Cloneable {
    ...
    private ChannelFuture doBind(final SocketAddress localAddress) {
        // 初始化 channel 和 将 SocketChannel 注册到指定的线程组上面，并返回一个 ChannelFuture
        ...
        // 由于 ChannelFuture 注册事件是异步的，这里可能已经完成
        if (regFuture.isDone()) {
    ...
    final ChannelFuture initAndRegister() {
        ...
        try {
            // 这里的 channelFactory 是我们在 BootStrap.channel(NioServerSocketChannel.class) 时 new 出来的
            // channelFactory 是 ReflectiveChannelFactory 基于反射的 channel 工厂
            // 这里会 new 出 NioServerSocketChannel 或者 NioSocketChannel，channel 各自会调其各自的构造方法
