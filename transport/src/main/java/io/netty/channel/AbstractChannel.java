...
public abstract class AbstractChannel extends DefaultAttributeMap implements Channel {
    ...
    protected AbstractChannel(Channel parent) {
        ...
        id = newId();
        // new 一个 unsafe
        // 如果是 NioServerSocketChannel 则对应的是 AbstractNioMessageChannel 的 newUnsafe() 方法
        unsafe = newUnsafe();
        // 创建 pipeline，并持有 pipeline，这里就存在了 channel 持有 pipeline 的指针了
        // 同样的，pipeline 被 new 出来的时候 也持有了 channel 的指针
    ...
    protected abstract class AbstractUnsafe implements Unsafe {
        ...
        public final void register(EventLoop eventLoop, final ChannelPromise promise) {
            ...
            // 如果当前线程在 EventLoopGroup 中，则直接使用当前线程注册
            // 如果不在，则使用线程组来注册，不占用任何其他线程
